...
const SVG = opt => {
	...
	canvasWidth = pixelsToMM("svg")['width'];
	canvasHeight = pixelsToMM("svg")['height'];
	...
	const initSVG = opt => {
		...
		svgElem.setAttribute("viewBox", opt.viewBox || `0 0 ${canvasWidth} ${canvasHeight}`);
		svgElem.setAttribute("width", `${pixelsToMM("svg")['width'] || 200}mm`);
		svgElem.setAttribute("height", `${pixelsToMM("svg")['height'] || 200}mm`);
		...
		rect.setAttribute("width", pixelsToMM("svg")['width']);
		rect.setAttribute("height", pixelsToMM("svg")['height']);
